...
public class W3CheckBoxSingle {
	...
	public static void clickOnSingleCheckbox() {
		WebElement lettuceCB;
		lettuceCB = driver.findElement(By.xpath("//div[text()='Lettuce']"));
		lettuceCB.click();
	}
	
	public static void clickOnSingleCheckbox(String name) {
		WebElement lettuceCB;
		lettuceCB = driver.findElement(By.xpath("//div[text()='"+name+"']"));
		lettuceCB.click();
	}
