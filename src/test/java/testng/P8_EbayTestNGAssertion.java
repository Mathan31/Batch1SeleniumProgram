...
public class P8_EbayTestNGAssertion {
	...
	public  void navigateURL() {
		...
		boolean logo = driver.findElement(By.id("gh-la")).isDisplayed();
		SoftAssert softAssert = new SoftAssert();
		softAssert.assertEquals(logo, false);
		String currentUrl = driver.getCurrentUrl();
		Assert.assertEquals(currentUrl, sURL);
