...
public class P5_EbayParameter {
	...
	@BeforeClass
	public  void invokeBrower(@Optional("2") int iBrowserType) {
		switch (iBrowserType) {
		case 1:
	...
	@Test(priority = 4)
	public  void searchProduct(@Optional("Selenium") String prodName,@Optional("Books") String prodCatagory) {
