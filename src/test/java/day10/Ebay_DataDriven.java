 ...
 */
	public static void getMatch(String sTxt) throws Exception {
		...
		for (int i = 1; i < oList.size(); i++) {
			...
			String sVal1 = oProduct.findElement(By.xpath(".//a[@class='s-item__link']"))
					.getText();
			...
			writeCellValueToExcel(sExcelFile, sTxt, i-1, 0, sVal1);
			writeCellValueToExcel(sExcelFile, sTxt, i-1, 1, sVal2);
		}
		ScrollPageto(0, 0);
